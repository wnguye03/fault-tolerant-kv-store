...
func TestBasic5A(t *testing.T) {
	// Test: one client (5A) ...
	GenericTest(t, "5A", 1, 5, false, false, false, -1, false)
}

func TestSpeed5A(t *testing.T) {
	GenericTestSpeed(t, "5A", -1)
}

func TestConcurrent5A(t *testing.T) {
	// Test: many clients (5A) ...
	GenericTest(t, "5A", 5, 5, false, false, false, -1, false)
}

func TestUnreliable5A(t *testing.T) {
	// Test: unreliable net, many clients (5A) ...
	GenericTest(t, "5A", 5, 5, true, false, false, -1, false)
}

func TestUnreliableOneKey5A(t *testing.T) {
	const nservers = 3
	...
	cfg.begin("Test: concurrent append to same key, unreliable (5A)")
...
func TestOnePartition5A(t *testing.T) {
	const nservers = 5
	...
	cfg.begin("Test: progress in majority (5A)")
	...
	cfg.begin("Test: no progress in minority (5A)")
	go func() {
	...
	cfg.begin("Test: completion after heal (5A)")
...
func TestManyPartitionsOneClient5A(t *testing.T) {
	// Test: partitions, one client (5A) ...
	GenericTest(t, "5A", 1, 5, false, false, true, -1, false)
}

func TestManyPartitionsManyClients5A(t *testing.T) {
	// Test: partitions, many clients (5A) ...
	GenericTest(t, "5A", 5, 5, false, false, true, -1, false)
}

func TestPersistOneClient5A(t *testing.T) {
	// Test: restarts, one client (5A) ...
	GenericTest(t, "5A", 1, 5, false, true, false, -1, false)
}

func TestPersistConcurrent5A(t *testing.T) {
	// Test: restarts, many clients (5A) ...
	GenericTest(t, "5A", 5, 5, false, true, false, -1, false)
}

func TestPersistConcurrentUnreliable5A(t *testing.T) {
	// Test: unreliable net, restarts, many clients (5A) ...
	GenericTest(t, "5A", 5, 5, true, true, false, -1, false)
}

func TestPersistPartition5A(t *testing.T) {
	// Test: restarts, partitions, many clients (5A) ...
	GenericTest(t, "5A", 5, 5, false, true, true, -1, false)
}

func TestPersistPartitionUnreliable5A(t *testing.T) {
	// Test: unreliable net, restarts, partitions, many clients (5A) ...
	GenericTest(t, "5A", 5, 5, true, true, true, -1, false)
}

func TestPersistPartitionUnreliableLinearizable5A(t *testing.T) {
	// Test: unreliable net, restarts, partitions, random keys, many clients (5A) ...
	GenericTest(t, "5A", 15, 7, true, true, true, -1, true)
}
